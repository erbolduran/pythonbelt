...
class User(models.Model):
    gallons = models.IntegerField(null=True)
    ...
    def __unicode__(self):
        return 'first_name: {}, last_name: {}, email: {}, address: {}, password: {}, credit_card: {}, gallons: {}, id: {}'.format(self.first_name, self.last_name, self.email, self.address, self.password, self.credit_card, self.gallons, self.id)
